...
func (a *App) initGRPCServer(ctx context.Context) error {
	...
	inventoryv1.RegisterInventoryServiceServer(a.grpcServer, a.diContainer.PartV1API(ctx))

	return nil
}

func (a *App) runGRPCServer(ctx context.Context) error {
	logger.Info(ctx, fmt.Sprintf("GRPC inventory service listening on %s", config.AppConfig().InventoryGRPC.Address()))
