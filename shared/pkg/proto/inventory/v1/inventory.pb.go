...
const (
	...
	CategoryType_CATEGORY_TYPE_ENGINE      CategoryType = 1
	CategoryType_CATEGORY_TYPE_FUEL        CategoryType = 2
	CategoryType_CATEGORY_TYPE_PORTHOLE    CategoryType = 3
	CategoryType_CATEGORY_TYPE_WING        CategoryType = 4
)
...
var (
	CategoryType_name = map[int32]string{
		...
		1: "CATEGORY_TYPE_ENGINE",
		2: "CATEGORY_TYPE_FUEL",
		3: "CATEGORY_TYPE_PORTHOLE",
		4: "CATEGORY_TYPE_WING",
	}
	CategoryType_value = map[string]int32{
		"CATEGORY_TYPE_UNSPECIFIED": 0,
		"CATEGORY_TYPE_ENGINE":      1,
		"CATEGORY_TYPE_FUEL":        2,
		"CATEGORY_TYPE_PORTHOLE":    3,
		"CATEGORY_TYPE_WING":        4,
	}
)
...
type PartsFilter struct {
	...
	Categories            []CategoryType         `protobuf:"varint,3,rep,packed,name=categories,proto3,enum=inventory.v1.CategoryType" json:"categories,omitempty"`
...
func (x *PartsFilter) GetCategories() []CategoryType {
	if x != nil {
		return x.Categories
	}
	return nil
...
type Part struct {
	...
	Category      CategoryType           `protobuf:"varint,6,opt,name=category,proto3,enum=inventory.v1.CategoryType" json:"category,omitempty"`
...
func (x *Part) GetCategory() CategoryType {
	if x != nil {
		return x.Category
	}
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\bcategory\x18\x06 \x01(\x0e2\x1a.inventory.v1.CategoryTypeR\bcategory\x128\n" +
	"\n" +
	...
	"\x14CATEGORY_TYPE_ENGINE\x10\x01\x12\x16\n" +
	"\x12CATEGORY_TYPE_FUEL\x10\x02\x12\x1a\n" +
	"\x16CATEGORY_TYPE_PORTHOLE\x10\x03\x12\x16\n" +
	"\x12CATEGORY_TYPE_WING\x10\x042\xa8\x01\n" +
	"\x10InventoryService\x12F\n" +
	"\aGetPart\x12\x1c.inventory.v1.GetPartRequest\x1a\x1d.inventory.v1.GetPartResponse\x12L\n" +
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseBRZPgithub.com/massodo1993/service-example/shared/pkg/proto/inventory/v1;inventoryv1b\x06proto3"
...
var file_inventory_v1_inventory_proto_goTypes = []any{
	(CategoryType)(0),             // 0: inventory.v1.CategoryType
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	...
	0,  // 3: inventory.v1.PartsFilter.categories:type_name -> inventory.v1.CategoryType
	0,  // 4: inventory.v1.Part.category:type_name -> inventory.v1.CategoryType
