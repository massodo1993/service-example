...
import (
	...
	"github.com/massodo1993/service-example/platform/pkg/grpc/health"
...
func (a *App) runGRPCServer(ctx context.Context) error {
	logger.Info(ctx, fmt.Sprintf("GRPC payemnt service listening on %s", config.AppConfig().PaymentGRPC.Address()))
